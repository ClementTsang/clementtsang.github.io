<template>
	<div id="app">
		<b-navbar toggleable="md" fixed="top" type="dark" variant="dark" style="height: 6em; background-color: #202124 !important;">
			<b-navbar-brand to="/#home">Clement Tsang</b-navbar-brand>
